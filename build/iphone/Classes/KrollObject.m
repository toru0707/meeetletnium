 ...
 * Copyright (c) 2009-2011 by meeetletnium, Inc. All Rights Reserved.
...
//@interface meeetletniumObject : NSObject
//@end

@interface meeetletniumObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[meeetletniumObject class]])
		{
			for (NSString *key in [[(meeetletniumObject*)o modules] allKeys])
			{
