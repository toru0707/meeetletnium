...
// in simulator we redefine to format for meeetletnium Developer console
...
{\
	NSString * exceptionName = [@"org.meeetletnium." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.meeetletnium";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UImeeetletniumNativeItemNone = -1, 
	UImeeetletniumNativeItemSpinner = -2,
	UImeeetletniumNativeItemProgressBar = -3,
	
	UImeeetletniumNativeItemSlider = -4,
	UImeeetletniumNativeItemSwitch = -5,
	UImeeetletniumNativeItemMultiButton = -6,
	UImeeetletniumNativeItemSegmented = -7,
	
	UImeeetletniumNativeItemTextView = -8,
	UImeeetletniumNativeItemTextField = -9,
	UImeeetletniumNativeItemSearchBar = -10,
	
	UImeeetletniumNativeItemPicker = -11,
	UImeeetletniumNativeItemDatePicker = -12,
	
	UImeeetletniumNativeItemInfoLight = -13,
	UImeeetletniumNativeItemInfoDark = -14,
	
	UImeeetletniumNativeItemDisclosure = -15,
	
	UImeeetletniumNativeItemContactAdd = -16
};
