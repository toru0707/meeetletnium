...
@interface meeetletniumObject : KrollCoverageObject {
#else
@interface meeetletniumObject : KrollObject {
#endif
@private
...
extern NSString * meeetletnium$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	meeetletniumObject *_meeetletnium;
	BOOL shutdown;
